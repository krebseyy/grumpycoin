    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Grumpycoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  grumpycoind [options]                     " + "\n" +
                  "  grumpycoind [options] <command> [params]  " + _("Send command to -server or grumpycoind") + "\n" +
                  "  grumpycoind [options] help                " + _("List commands") + "\n" +
                  "  grumpycoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: grumpycoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 3433 or testnet: 13433)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 3432 or testnet: 13432)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Grumpycoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Grumpycoin is probably already running."), strDataDir.c_str()));
